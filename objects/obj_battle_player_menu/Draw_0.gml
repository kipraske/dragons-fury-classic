...
for ( var i = 0; i < _frontline_length; i++ ) {
	...
	draw_text_shadow( x + menu_sprite_gap + 34, y + menu_item_spacing*i + hp_pos - sub_menu_spacing, "HP");
	draw_text_shadow( x + menu_sprite_gap + 34, y + menu_item_spacing*i + mp_pos - sub_menu_spacing, "MP");
...
for ( var i = 0; i < _backline_length; i++ ) {
	...
	draw_set_font(ft_stat_heading);
	draw_text_shadow( x + menu_sprite_gap + 34, y + menu_item_spacing*(i + _frontline_length) + hp_pos - sub_menu_spacing, "HP");
	draw_text_shadow( x + menu_sprite_gap + 34, y + menu_item_spacing*(i + _frontline_length) + mp_pos - sub_menu_spacing, "MP");
	

	draw_set_halign(fa_right);
	draw_set_font(ft_damage);
	draw_text_shadow( x + menu_width - 16, y + menu_item_spacing*(i + _frontline_length) + 0.5*hp_pos, global.battle.player_backline[i].battle_stats[stats.current_HP]);
	draw_text_shadow( x + menu_width - 16, y + menu_item_spacing*(i + _frontline_length) + mp_pos, global.battle.player_backline[i].battle_stats[stats.current_MP]);
}

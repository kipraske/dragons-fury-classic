...
for ( var i = 0; i < _backline_length; i++ ) {
	...
	draw_set_font(ft_stat_heading);
	draw_text_shadow( x + menu_sprite_gap + 16, y + menu_item_spacing*(i + _frontline_length) + 5*sub_menu_spacing, "HP");
	draw_text_shadow( x + menu_sprite_gap + 16, y + menu_item_spacing*(i + _frontline_length) + 9*sub_menu_spacing, "MP");
}

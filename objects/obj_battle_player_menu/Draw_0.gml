...
for ( var i = 0; i < _frontline_length; i++ ) {
	...
	draw_healthbar( x + 3*menu_sprite_gap, y + menu_item_spacing*i + mp_pos + 2, x + menu_width - 16, y + menu_item_spacing*i + mp_pos + 10, _mp_percent, c_grey, c_navy, c_blue, 0, true, true);

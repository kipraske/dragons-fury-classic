...
function init_game_state(){
	...
	if ( global.history ){
		...
		global.battle = {
			...
			player_backline: [],
			monster_units: [],
			selected_actions: fill_array(MAX_TOTAL_UNITS, skills.noskill), // parallel with player_frontline + player_backline
			selected_targets: fill_array(MAX_TOTAL_UNITS, noone), // "
			monster_layout: 0,
